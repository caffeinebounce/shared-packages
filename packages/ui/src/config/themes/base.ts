 ...
 *
 * Core theme definitions used by both the theme registry and product themes.
 * This file exists to prevent circular dependencies between index.ts and products.ts.
 */
