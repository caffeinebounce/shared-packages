 ...
 */
export function ChartTooltipShell({ children, className }: ChartTooltipShellProps) {
  return (
...
export function ChartTooltipRow({ color, label, value, isNegative }: ChartTooltipRowProps) {
  return (
    <div className="flex items-center justify-between gap-4 text-xs">
      ...
      <span className={cn("font-mono font-medium", isNegative && "text-destructive")}>
        {value}
      </span>
    </div>
  );
