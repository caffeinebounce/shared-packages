  ...
  return (
    <div className="w-48">
      ...
      <div className="flex items-center gap-1 px-2 py-1.5 border-b border-border/40">
        ...
        >
          <SelectTrigger className="h-5 w-auto gap-0.5 border border-sky-200 bg-sky-50 dark:bg-sky-950/30 dark:border-sky-800 px-1.5 text-xs hover:bg-sky-100 dark:hover:bg-sky-900/40 rounded">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
