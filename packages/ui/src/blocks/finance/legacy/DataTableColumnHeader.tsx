...
// The statement table still describes columns with the legacy meta shape. Merge
// those fields into TanStack's ColumnMeta (tablecn's augmentation owns `icon`).
// `icon` is spelled exactly as tablecn spells it so the two augmentations merge.
type LegacyColumnMetaFields = Partial<Omit<DataTableColumnMeta, "icon">> & {
  allowHorizontalScroll?: boolean;
  icon?: React.ComponentType<React.ComponentProps<"svg">>;
};
declare module "@tanstack/react-table" {
  interface ColumnMeta<TData extends RowData, TValue>
    extends LegacyColumnMetaFields {}
}
