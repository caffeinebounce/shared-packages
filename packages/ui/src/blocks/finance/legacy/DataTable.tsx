// LEGACY ENGINE — private to blocks/finance. FinancialStatementTable is the only
// consumer (tree view, column resizing, sticky columns). Everything else uses
// blocks/table (tablecn). Do not export from the package root; do not extend.
"use client";
